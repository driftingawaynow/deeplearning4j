 ...
 *
 * Description: The realtime graph for the runtime of the neural network
 *
 * ****************************************
 */
...
public class RuntimePlot extends Application {
    ...
    private void initLineChart(CategoryAxis xAxis, NumberAxis yAxis) {
        ...
        lineChart.setTitle("Neural Network Runtime Plot");
     ...
     */
    public void addRuntimeToRealTime(String xAxis, double yAxis) {
